						...
						if (hit2d.collider != null) {
								if (hit2d.collider.tag == "ColorsWheel" || hit2d.collider.tag == "WheelColor") {
										if (isWheelRotating) {//if wheel is rotating
												...
												if (hit2d.collider.CompareTag("WheelColor")) {//if there is a click on wheelcolor
														StopAllCoroutines ();
														isLerpingToTarget = false;
												} else if (hit2d.collider.CompareTag("ColorsWheel")) {//if there is a click on colorswheel
														StopAllCoroutines ();
														isLerpingToTarget = false;
												}
										}
