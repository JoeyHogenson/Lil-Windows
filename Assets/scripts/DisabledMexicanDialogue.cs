...
public class DisabledMexicanDialogue : MonoBehaviour
{
    ...
    void Start()
    {
        NPC.idleDialogueLines = File.ReadAllLines(Path.Combine(Application.streamingAssetsPath, "DisabledMexicanDialogue.txt"));
        /*
